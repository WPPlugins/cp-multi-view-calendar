...
function updateDetailedCalendar($id, $st, $et, $sub, $ade, $dscr, $loc, $color, $rrule,$rruleType,$tz){
  ...
  try{ 
    ...
    { 
        ...
        {
            $sql = "update `".DC_MV_CAL."` set"
              . " `".DC_MV_CAL_FROM."`=concat(substring(".DC_MV_CAL_FROM.",1,11),'" . substr(php2MySqlTime(js2PhpTime($st)),-8) . "'), "
              . " `".DC_MV_CAL_TO."`=concat(substring(".DC_MV_CAL_TO.",1,11),'" . substr(php2MySqlTime(js2PhpTime($et)),-8) . "'), "
