...
<?php
    ...
    public function plugin_page_links($links) {
        $customAdjustments_link = '<a href="http://wordpress.dwbooster.com/calendars/cp-multi-view-calendar#download">'.__('Upgrade To Premium').'</a>';
...
[<a href="https://wordpress.org/support/plugin/cp-multi-view-calendar#new-post" target="_blank">Support</a>] | [<a href="http://wordpress.dwbooster.com/calendars/cp-multi-view-calendar" target="_blank">Documentation</a>]
